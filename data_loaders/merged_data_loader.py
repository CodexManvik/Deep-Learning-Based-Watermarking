...
class MergedDataLoader(BaseDataLoader):
    ...
    def __init__(
        ...
        use_paper_attack_distribution: bool = True,
        ...
        # 3) Infinite attack-id generator (paper-compliant distribution or disabled)
        self.attack_stream = AttackIdDataLoader(
            min_value=attack_min_id,
            max_value=attack_max_id,
            use_paper_distribution=use_paper_attack_distribution,
